...
it("loads assignees on a fresh Tasks page and saves the chosen task contract", async () => {
  ...
  expect(api.createTask).toHaveBeenCalledWith(expect.objectContaining({ owner_object_id: "user-1", work_kind: "code", github_issue_url: "https://github.com/example/project/issues/42", due_at: new Date("2099-01-02T17:00").toISOString() }));
});
