...
async fn validates_commits_and_replays_one_atomic_source_batch() {
    ...
    let payload = json!({
        ...
        "artifacts":[{"client_key":"source-1-v1","object":{"client_key":"source-1"},"kind":"paper_text","title":"Captured paper text","content":normalized_text,"uri":null,"media_type":"text/plain","sha256":content_hash,"size_bytes":normalized_text.len(),"language":"en","captured_at":"2026-08-30T00:00:00Z","capture_outcome":"complete","capture_reason":null,"expected_size_bytes":normalized_text.len(),"metadata":{"extraction_method":"test","extraction_version":"1","coverage":"complete"},"supersedes_artifact_id":null}],
        "connections":[
