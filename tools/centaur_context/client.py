...
DEFAULT_SOURCE_INTAKE_URL = "http://centaur-context-source-intake.centaur.svc.cluster.local:8086"
DEFAULT_RESEARCH_MUTATION_URL = "http://centaur-context-research-mutation.centaur.svc.cluster.local:8087"
DEFAULT_EXTERNAL_ACTION_URL = "http://centaur-context-external-action.centaur.svc.cluster.local:8088"
...
class CentaurContextClient:
    ...
    def _source_intake_token(self) -> str:
        ...
        if not value:
            raise RuntimeError(
                f"{SOURCE_INTAKE_TOKEN_NAME} is required for Source intake"
            )
        return value
    ...
    def source_intake_validate(
        ...
        """Validate one Source manifest without writing rows."""
    ...
    def source_intake_commit(
        ...
        """Atomically commit or replay one Source manifest."""
        return self._source_intake_request(
    ...
    def source_intake_status(
        ...
        """Check commit and retrieval readiness for one Source manifest."""
        return self._source_intake_request(
